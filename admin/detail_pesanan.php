...
// Pastikan query berhasil dieksekusi sebelum mencoba mengambil hasilnya
if ($query_pesanan) {
    $data_pesanan = mysqli_fetch_assoc($query_pesanan);
} else {
    // Handle kesalahan kueri
    echo "Error executing query: " . mysqli_error($conn);
    // Exit dari skrip jika kueri gagal
    exit();
}

// Ambil data detail pesanan berdasarkan id_pesanan
$query_detail = mysqli_query($conn, "SELECT detail_pesanan.*, produk.nama_model, produk.harga_produk * detail_pesanan.jumlah_pesanan AS subtotal
                                     FROM detail_pesanan
    ...
    <div class="container">
        <div class="row justify-content-center title-container">
            <div class="back-button">
                <a href="pesanan_member.php"><i class="fa fa-arrow-left"></i></a>
            </div>
