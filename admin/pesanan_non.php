...
<div class="container">
    <div class="row justify-content-center title-container"> 
        ...
        <h1 class="text-center">Data Pesanan Pembeli</h1>
    </div>
        ...
        <div class="col-lg-9">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php 
                        $nomor=1;
                        $sql = mysqli_query($conn, "SELECT pesanan.id_pesanan, pembeli.nama_pembeli, pesanan.tanggal_pesanan, pesanan.alamat_pesanan, pesanan.status_pesanan, pesanan.total_harga_pesanan,pesanan.jenis_pembayaran 
                            FROM pesanan 
                            JOIN pembeli ON pesanan.nama_pesanan COLLATE utf8mb4_unicode_ci = pembeli.nama_pembeli COLLATE utf8mb4_unicode_ci
                    ...
                    <tr class="text-center">
                        ...
                        <td><a href="detail_pesanan_non.php?id=<?php echo $pecah['id_pesanan'];?>" class="btn btn-custom">Detail</a></td>
                    </tr>
                    <?php $nomor++ ?>
                    <?php } ?>
                </tbody>
