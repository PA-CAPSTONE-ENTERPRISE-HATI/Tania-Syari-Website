...
function addProductToCart(title, price, productImg) {
    ...
    xhr.open("POST", "http://localhost/capstone/baju/users/cart.php", true);
...
function updateTotal() {
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
        ...
        // Remove 'Rp' and replace dot (.) with nothing for thousands separator, and replace comma (,) with dot (.) for decimal separator
